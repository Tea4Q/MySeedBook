...
import { Image, View, Text, TextInput, Pressable, Modal, StyleSheet, ActivityIndicator, ScrollView, FlatList } from 'react-native';
        ...
        {selectedSupplier ? (
          <View style={styles.selectedSupplierPreview}>
             {selectedSupplier.supplier_image && (
              <Image source={{ uri: selectedSupplier.supplier_image }} style={styles.supplierImage} />
            )}
